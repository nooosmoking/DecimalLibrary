...
Suite *suite_s21_is_less_or_equal(void) {
  ...
  tcase_add_test(tc_insert, s21_is_less_or_equal_9);
  tcase_add_test(tc_insert, s21_is_less_or_equal_10);
  tcase_add_test(tc_insert, s21_is_less_or_equal_11);
  tcase_add_test(tc_insert, s21_is_less_or_equal_12);
